...
public class ImcRangeTest {
    ...
    @Test
    public void givenCallGetImcRange_whenUnderWeightImcRange_thenReturnFirstRecordOnTheListRanges() {
    ...
    @Test
    public void givenCallGetImcRange_whenNormalWeightImcRange_thenReturnSecondRecordOnTheListRanges() {
    ...
    @Test
    public void givenCallGetImcRange_whenOverweightImcRange_thenReturnThirdRecordOnTheListRanges() {
    ...
    @Test
    public void givenCallGetImcRange_whenGradeOneObesityImcRange_thenReturnFourthRecordOnTheListRanges() {
    ...
    @Test
    public void givenCallGetImcRange_whenGradeTwoObesityImcRange_thenReturnFifthRecordOnTheListRanges() {
